/*
 * PaymentsCodeSuccessUIPanel.java
 *
 ...
 */
public class PaymentsCodeSuccessUIPanel extends EAPanel {
    Map sbMap = Collections.synchronizedMap(new HashMap());  
    EAPanel uiPanel;
    EAPanel actPanel;

    /** Creates new form PaymentsCodeSuccessUIPanel */
    public PaymentsCodeSuccessUIPanel() {
        initComponents();
	  initSidebar();
