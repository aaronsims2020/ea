...
public class PaymentFailureValidationHeaderPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
	  ...
	  if(ProjectManager.get("paymentFailureLabelHeaderTextFont")!=null)
	  {
		if(ProjectManager.get("paymentFailureLabelHeaderTextFont").equalsIgnoreCase("")==false)
		{
			try
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("paymentFailureLabelHeaderTextFont"));
	...
	try
	{
      	...
      	{
        		taValidationResponse.setText(replaceUIExpressions(ProjectManager.get("paymentFailureResponsePanelHeaderDescription")));
		}
	}
	catch(Exception e)
	{
	  ...
	  if(ProjectManager.get("paymentFailureLabelHeaderTextColor")!=null)
	  {
		if(ProjectManager.get("paymentFailureLabelHeaderTextColor").equalsIgnoreCase("")==false)
		{
			try
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("paymentFailureLabelHeaderTextColor"));
