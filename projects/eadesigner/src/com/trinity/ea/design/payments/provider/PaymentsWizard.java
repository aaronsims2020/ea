 ...
 */
public class PaymentsWizard extends javax.swing.JFrame {
    private java.awt.Image TitleBarIcon = null;
    private PaymentsWizardMainPanel optinWiz;
    public PaymentsWizard()
    {
	new PaymentsWizard(0);
    }

    /** Creates new form PaymentsWizard */
    public PaymentsWizard(int wizPanel)
{
	  if(wizPanel==0)
	  {
		optinWiz = new PaymentsWizardMainPanel(0);
	  	optinWiz.setMasterControlPanel(this);
	  }
	  else if(wizPanel==1)
	  {
		optinWiz = new PaymentsWizardMainPanel(1);
	  	optinWiz.setMasterControlPanel(this);
	  }
        initComponents();
        try
...
/**/   
  ...
  private void setWizardPanel(JPanel theWizardPanel)
  {
	...
	EADesignerPaymentsPanel eadopRef = null;
	public void setMasterControlPanel(EADesignerPaymentsPanel eadop)
	{	
		eadopRef = eadop;
	}
