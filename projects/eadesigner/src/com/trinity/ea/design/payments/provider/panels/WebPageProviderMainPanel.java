...
import com.trinity.ea.design.payments.provider.panels.WebPagePaymentProvider;
 ...
 */
public class WebPageProviderMainPanel extends EAPanel{
    
    private WebPagePaymentProvider WebPagePaymentProvider = new WebPagePaymentProvider();
    /** Creates new form WebPageProviderMainPanel */
    public WebPageProviderMainPanel() {
	  super();
        initComponents();
        WebPagePaymentProvider.setMasterStatusController(this);
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NewProjectImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/webpageprovider.png")));
        ...
        NewProjectDescription.setText("Specify your Payment Processing Web Page URL, and click the \"Finish\" button to generate the Payment Processing configuration.");
        ...
        CenterNewProjectPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(), "Payment Processing Web Page Configuration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        ...
        RightContentPanel.add(WebPagePaymentProvider, java.awt.BorderLayout.CENTER);
	...
	{ 
       setStatus("Please specify a Payment Processing Web Page URL.");
	}
	else
	{
       setStatus("Click to complete your Payment Processing Web Page configuration.");
	}
