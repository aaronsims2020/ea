/*
 * GoemerchantProviderMainPanel.java
 *
...
import com.trinity.ea.design.payments.provider.panels.GoemerchantPaymentProvider;
 ...
 */
public class GoemerchantProviderMainPanel extends EAPanel{
    
    private GoemerchantPaymentProvider GoemerchantPaymentProvider = new GoemerchantPaymentProvider();
    /** Creates new form GoemerchantProviderMainPanel */
    public GoemerchantProviderMainPanel() {
	  super();
        initComponents();
        GoemerchantPaymentProvider.setMasterStatusController(this);
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NorthNewProjectPanel.setBackground(new java.awt.Color(204, 204, 204));
        NorthNewProjectPanelCenterPanel.setLayout(new java.awt.BorderLayout(10,10));

        NorthNewProjectPanelCenterPanel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        NewProjectImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/thirdparty/goemerchantlogoblack.gif")));
        ...
        NewProjectDescription.setBackground(new java.awt.Color(204, 204, 204));
        NewProjectDescription.setEditable(false);
        NewProjectDescription.setLineWrap(true);
        NewProjectDescription.setText("Specify the merchant name assigned by GoEmerchant.com, Product Price, and click the \"Finish\" button to generate the Payment Processing configuration.");
        ...
        NorthNewProjectPanelSouthPanel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        CenterNewProjectPanel.setBackground(new java.awt.Color(204, 204, 204));
        CenterNewProjectPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(), "goEmerchant.com Payment Processing Configuration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        RightContentPanel.setLayout(new java.awt.BorderLayout());

        RightContentPanel.setBackground(new java.awt.Color(204, 204, 204));
        NewProjectPanelFileBox.setLayout(new javax.swing.BoxLayout(NewProjectPanelFileBox, javax.swing.BoxLayout.Y_AXIS));

        NewProjectPanelFileBox.setBackground(new java.awt.Color(204, 204, 204));
        SouthNewProjectPanelTopPanel1.setBackground(new java.awt.Color(204, 204, 204));
        ...
        SouthNewProjectPanelTopPanel3.setBackground(new java.awt.Color(204, 204, 204));
        ...
        RightContentPanel.add(GoemerchantPaymentProvider, java.awt.BorderLayout.CENTER);
        ...
        SouthNewProjectPanel.setBackground(new java.awt.Color(204, 204, 204));
        SouthNewProjectPanelTopPanel.setLayout(new java.awt.BorderLayout());

        SouthNewProjectPanelTopPanel.setBackground(new java.awt.Color(204, 204, 204));
        HelpStatusLabel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        HorizontalRulePanel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        SouthNewProjectPanelBottomPanel.setBackground(new java.awt.Color(204, 204, 204));
        LeftButtonPanel.setLayout(new java.awt.FlowLayout());

        LeftButtonPanel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        AdvancedDesignerButton.setBackground(new java.awt.Color(204, 204, 204));
        ...
        RightButtonPanel.setBackground(new java.awt.Color(204, 204, 204));
	...
	{
       setStatus("Click to complete your goEmerchant.com Payment Processing configuration.");
	}
    ...
    private void NewProjectImagePanelMouseEntered(java.awt.event.MouseEvent evt) {
        setStatus("goEmerchant LLC doing business as goEmerchant.com is a registered ISO of Regions Bank.");
    }    
    ...
    private void NextButtonActionPerformed(java.awt.event.ActionEvent evt) {
	  try      
  	  {
		GoemerchantPaymentProvider.getDataUpdate();
