 ...
 */
public class PaymentsCodeUIPanel extends EAPanel {
    Map sbMap = Collections.synchronizedMap(new HashMap());  

    /** Creates new form PaymentsCodeUIPanel */
    public PaymentsCodeUIPanel() {
        initComponents();
	  initSidebar();
...
// add header here
  ...
  public void getDataUpdate()
  {
	...
	((EADesignerRegistrationPanel)getParentComponent()).setRegistrationCodeUserInterfacePropertyPanel();
 	setSelectedMenuItem(lUserInterfaceMenuItem);
