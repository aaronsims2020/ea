...
package com.trinity.ea.design.payments.preview.gui.swing;
import com.trinity.ea.design.payments.preview.gui.swing.ErrorPane;
	  ...
	  else
	  {
		...
		if(ProjectManager.get("paymentImgCancelButtonFace")!=null)
		{
			if(ProjectManager.get("paymentImgCancelButtonFace").equalsIgnoreCase("")==false)
			{
				try
				{
					btnFaceCancel = new javax.swing.ImageIcon(getClass().getResource(ProjectManager.get("paymentImgCancelButtonFace")));
				}
				catch(Exception e)
				{
					e.printStackTrace();
		...
		if(ProjectManager.get("paymentImgCancelButtonFaceOnClick")!=null)
		{
			if(ProjectManager.get("paymentImgCancelButtonFaceOnClick").equalsIgnoreCase("")==false)
			{
				try
				{
					btnFaceOnClickCancel = new javax.swing.ImageIcon(getClass().getResource(ProjectManager.get("paymentImgCancelButtonFaceOnClick")));
		...
		if(ProjectManager.get("paymentImgCancelButtonFaceInFocus")!=null)
		{
			if(ProjectManager.get("paymentImgCancelButtonFaceInFocus").equalsIgnoreCase("")==false)
			{
				try
				{
					btnFaceInFocusCancel = new javax.swing.ImageIcon(getClass().getResource(ProjectManager.get("paymentImgCancelButtonFaceInFocus")));
				}
				catch(Exception e)
				{
					e.printStackTrace();
