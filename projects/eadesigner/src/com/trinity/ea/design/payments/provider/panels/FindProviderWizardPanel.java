 ...
 */
public class FindProviderWizardPanel extends EAPanel{
    PaymentsWizardMainPanel theParentObj = null;
    
	/** Creates new form OptinWizardStep1 */
    public FindProviderWizardPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NewProjectImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/findprovider.png")));
        ...
        NewProjectDescription.setText("Select a Payment Processing Gateway Preferred Provider from the Providers list, and click the \"Next\" button to load the provider information in your web browser.");
        ...
        ProjectList.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "<html><b>&nbsp;1. Skipjack Transaction Network</b> - http://www.skipjack.com/</html>"};
    ...
    private void AboutButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AboutButtonMouseEntered
                setStatus("Open the Preferred Provider's web page.");
    ...
    private void NextButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NextButtonMouseEntered
       HelpStatusLabel.setText("Continue to the \"configure provider\" step, and open the Preferred Provider's web page.");
	...
	{
		theParentObj.setLoadWebPage(ProjectList.getSelectedIndex());
	}
	else
	{
		JOptionPane.showMessageDialog(new JFrame(), "Please select a Preferred Provider to continue to the next step.");
	}
