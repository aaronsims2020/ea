 ...
 */
public class SkipjackPaymentProvider extends javax.swing.JPanel 
{
 ...
 /** Creates new form SkipjackPaymentProvider */
    ...
    private void lMerchantIDMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lMerchantIDMouseEntered
        setStatus("Specify the Skipjack Account HTML Processing Serial Number.");
    ...
    SkipjackProviderMainPanel parentObj = null;
    public void setMasterStatusController(Object parentObject)
    {
        parentObj = (SkipjackProviderMainPanel)parentObject;
    }
