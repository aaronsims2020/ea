...
import com.trinity.ea.design.registration.preview.gui.swing.ErrorPane;
...
import com.trinity.ea.design.registration.preview.gui.swing.ImageBackgroundBorder;
...
try
{
        		Logo.setIcon(new javax.swing.ImageIcon(new URL(ProjectManager.get("errHeaderImgPath"))));
...
try
{
			...
			if(ProjectManager.get("errBGImgPath")!=null)
			{
				...
				{
        				final Border bkgrnd = new ImageBackgroundBorder(ImageIO.read(new URL(ProjectManager.get("errBGImgPath"))));
