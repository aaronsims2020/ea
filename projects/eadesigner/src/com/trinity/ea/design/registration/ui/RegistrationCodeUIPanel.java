 ...
 */
public class RegistrationCodeUIPanel extends EAPanel {
    Map sbMap = Collections.synchronizedMap(new HashMap());  

    /** Creates new form RegistrationCodeUIPanel */
    public RegistrationCodeUIPanel() {
        initComponents();
	  initSidebar();
