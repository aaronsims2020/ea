...
import com.trinity.ea.design.messaging.config.MaxURLsAllowed;
import com.trinity.ea.design.messaging.JarVerificationSecurityPanel;
 ...
 */
public class MessagingConfigPanel extends EAMasterControlPanel {
    ...
    /** Creates new form MessagingConfigPanel */
    public MessagingConfigPanel() {
        initComponents();
	  setProjectData();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        allowActionExecutionInCustomMessagesEnabled = new javax.swing.JCheckBox();
        allowServerNotificationOfMessageReceivedStatusEnabled = new javax.swing.JCheckBox();
...
//PaymentMethodsGroupPanel.add(theEAProperties);
        ...
        cbAllowURLChanges.setText("Allow URL changes via messages");
        ...
        allowActionExecutionInCustomMessagesEnabled.setBackground(new java.awt.Color(140, 160, 210));
        allowActionExecutionInCustomMessagesEnabled.setFont(new java.awt.Font("Dialog", 0, 12));
        allowActionExecutionInCustomMessagesEnabled.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        allowActionExecutionInCustomMessagesEnabled.setLabel("Allow action execution for custom messages");
        allowActionExecutionInCustomMessagesEnabled.setMaximumSize(new java.awt.Dimension(500, 25));
        allowActionExecutionInCustomMessagesEnabled.setMinimumSize(new java.awt.Dimension(350, 25));
        allowActionExecutionInCustomMessagesEnabled.setPreferredSize(new java.awt.Dimension(500, 25));
        jPanel18.add(allowActionExecutionInCustomMessagesEnabled, java.awt.BorderLayout.CENTER);

        allowServerNotificationOfMessageReceivedStatusEnabled.setBackground(new java.awt.Color(140, 160, 210));
        allowServerNotificationOfMessageReceivedStatusEnabled.setFont(new java.awt.Font("Dialog", 0, 12));
        allowServerNotificationOfMessageReceivedStatusEnabled.setLabel("Allow server notification of message delivery status");
        allowServerNotificationOfMessageReceivedStatusEnabled.setMaximumSize(new java.awt.Dimension(350, 25));
        allowServerNotificationOfMessageReceivedStatusEnabled.setMinimumSize(new java.awt.Dimension(350, 25));
        allowServerNotificationOfMessageReceivedStatusEnabled.setPreferredSize(new java.awt.Dimension(350, 25));
        jPanel18.add(allowServerNotificationOfMessageReceivedStatusEnabled, java.awt.BorderLayout.SOUTH);
       ...
       // allowSoftwareUpdateExpirationProcessingEnabled.setLabel("Disable Messaging Java Code Signing Validation");
...
//
 ...
 /*
	...
	try
	{
		...
		strTempActionsArray[0]="msgBaseURL";
		...
		strTempActionsArray[ActionsEAListItemArray.length]="msgAlternateURL" + String.valueOf(ActionsEAListItemArray.length - 1);
...
*/
    ...
    public synchronized void setProjectData()
    {
		...
		// Automatic Update Support Functionality Checkbox Enabled/Disabled   
            if(ProjectManager.get("msgAllowExecuteActionsOnCustomMessages").equalsIgnoreCase("true")==true)
            {
                allowActionExecutionInCustomMessagesEnabled.setSelected(true);              
            }
            else
            {
                allowActionExecutionInCustomMessagesEnabled.setSelected(false);               
            }
            if(ProjectManager.get("msgAllowNotifyServerOnMessageReceivedStatus").equalsIgnoreCase("true")==true)
            {
                allowServerNotificationOfMessageReceivedStatusEnabled.setSelected(true);              
            }
            else
            {
                allowServerNotificationOfMessageReceivedStatusEnabled.setSelected(false);               
            }
  ...
  public void getDataUpdate()
  {
	try
	{
			...
			if(0<theItems.length)
			{
				for(int i = 0;i<theItems.length;i++)
				{
						...
						if(1<theStrArray.length)
						{
							if(i==0)
							{
								ProjectManager.putTempNoFileWrite("msgBaseURL", theItems[0].getInputText());
							}
							else
							{
								ProjectManager.putTempNoFileWrite("msgAlternateURL" + String.valueOf(i), theStrArray[0]);
							}
						}
				}
			}
		...
		// Automatic Updates Support Functionality Checkbox Enabled/Disabled
            if(allowActionExecutionInCustomMessagesEnabled.isSelected()==true)
            {
		    ProjectManager.putTempNoFileWrite("msgAllowExecuteActionsOnCustomMessages", "true");
            }
            else
            {
		    ProjectManager.putTempNoFileWrite("msgAllowExecuteActionsOnCustomMessages", "false");
            }
            if(allowServerNotificationOfMessageReceivedStatusEnabled.isSelected()==true)
            {
		    ProjectManager.putTempNoFileWrite("msgAllowNotifyServerOnMessageReceivedStatus", "true");
            }
            else
            {
		    ProjectManager.putTempNoFileWrite("msgAllowNotifyServerOnMessageReceivedStatus", "false");
            }
    ...
    private javax.swing.JCheckBox allowActionExecutionInCustomMessagesEnabled;
    private javax.swing.JCheckBox allowServerNotificationOfMessageReceivedStatusEnabled;
