/*
 * MessageDialogDesignerPreview.java
 *
 ...
 */
public class MessageDialogDesignerPreview extends javax.swing.JDialog {
    ...
    public MessageDialogDesignerPreview(int msgtype, String msgTitle, String msgText, String msgFont, String textColor, String msgBtnFont, String msgBtnFontColor, String OKBtnText, char OKBtnMnemonic, int textAlignJustify) 
    {
    		new MessageDialogDesignerPreview(new javax.swing.JFrame(), true, msgtype, msgTitle, msgText, msgFont, textColor, msgBtnFont, msgBtnFontColor, OKBtnText, OKBtnMnemonic, textAlignJustify).show();
    }

    /** Creates new form MessageDialogDesignerPreview */
    public MessageDialogDesignerPreview(java.awt.Frame parent, boolean modal, int msgtype, String msgTitle, String msgText, String msgFont, String textColor, String msgBtnFont, String msgBtnFontColor, String OKBtnText, char OKBtnMnemonic, int textAlignJustify) 
    {
        super(parent, modal);
        try
        {
