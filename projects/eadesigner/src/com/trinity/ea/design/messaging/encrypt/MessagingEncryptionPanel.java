...
import com.trinity.ea.design.messaging.encrypt.EncryptionConfigurationPanel;
import com.trinity.ea.design.messaging.encrypt.X500EncryptionConfigurationPanel;
 ...
 */
public class MessagingEncryptionPanel extends EAPanel {
    
    /** Creates new form MessagingEncryptionPanel */
    public MessagingEncryptionPanel() {
        initComponents();
	  setProjectData();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
	  ...
	  ecp2 = new X500EncryptionConfigurationPanel();
        ...
        taOptionsDescription.setText("The Messaging Vendor Product Encryption information is defined below.");
