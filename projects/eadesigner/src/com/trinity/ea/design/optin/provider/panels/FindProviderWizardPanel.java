...
public class FindProviderWizardPanel extends EAPanel{
    OptinWizardMainPanel theParentObj = null;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NewProjectDescription.setText("Select an Opt-In Autoresponder Preferred Provider from the Providers list, and click the \"Next\" button to load the provider information in your web browser.");
        ...
        CenterNewProjectPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(), "Opt-In Autoresponder Providers", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        ...
        ProjectList.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "<html><b>&nbsp;1. AWeber</b> - http://www.aweber.com/</html>", "<html>&nbsp;<b>2.</b> GetResponse - http://www.getresponse.com/</html>"};
    ...
    private void ProjectListMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProjectListMouseEntered
        setStatus("Select your Opt-In Autoresponder provider, and click \"Next\" to continue."); 
    ...
    protected void setParentComponent(OptinWizardMainPanel parentObj)
    {
