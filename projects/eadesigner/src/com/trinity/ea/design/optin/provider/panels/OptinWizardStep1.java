...
public class OptinWizardStep1 extends EAPanel{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NewProjectDescription.setText("Select an Opt-In Autoresponder Preferred Provider from the Providers list, or select \"Unlisted Provider\" from the Providers list to configure a Provider not in the list.");
        ...
        ProjectList.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "<html><b>&nbsp;1. AWeber</b> - http://www.aweber.com/</html>", "<html>&nbsp;<b>2.</b> GetResponse - http://www.getresponse.com/</html>", "<html>&nbsp;<b>3.</b> Unlisted Provider - Configure an unlisted provider.</html>" };
    ...
    private void ExitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExitButtonActionPerformed	  try      
	try 
 	  {
