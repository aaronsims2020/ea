...
import com.trinity.ea.design.optin.preview.gui.swing.EAScrollBarUI;
...
public class PrivacyPolicy extends javax.swing.JDialog {
 ...
 if(isImageButton==true)
 {
	  ...
	  else
	  {
        ...
        {
        	setTitle(replaceUIExpressions(ProjectManager.get("privacyPolicyTitle")));
	  }
	  ...
	  Policy.setCaretPosition(0);
		if(ProjectManager.get("privacyPolicyTextBackgroundColor")!=null)
		{
			if(ProjectManager.get("privacyPolicyTextBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyTextBackgroundColor"));
		...
		if(ProjectManager.get("privacyPolicyTextColor")!=null)
		{
			if(ProjectManager.get("privacyPolicyTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyTextColor"));
		...
		if(ProjectManager.get("privacyPolicyButtonTextColor")!=null)
		{
			if(ProjectManager.get("privacyPolicyButtonTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyButtonTextColor"));
		...
		if(ProjectManager.get("privacyPolicyBackgroundColor")!=null)
		{
			if(ProjectManager.get("privacyPolicyBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyBackgroundColor"));
    ...
    private void initComponents(boolean isImgButton) {//GEN-BEGIN:initComponents
	  ...
	  Policy.setLineWrap(true);
		if(ProjectManager.get("privacyPolicy")!=null)
		{
	  		...
	  		Policy.setText(replaceUIExpressions(ProjectManager.get("privacyPolicy").replaceAll("\\\\r\\\\n", System.getProperty("line.separator"))));         
		} 
		...
		setResizable(false);
		if(ProjectManager.get("privacyPolicyTextFont")!=null)
		{
			Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyTextFont"));
		...
		if(ProjectManager.get("privacyPolicyOKBtnText")!=null)
		{
        if(isImageButton==true)
	  {
        	btnImageOK.setText(replaceUIExpressions(ProjectManager.get("privacyPolicyOKBtnText")));
	  }
	  else
	  {
        	btnOK.setText(replaceUIExpressions(ProjectManager.get("privacyPolicyOKBtnText")));
	  }
	  }
	  else
	  {
	  ...
	  if(isImageButton==true)
	  {
	  if(ProjectManager.get("privacyPolicyOKBtnMnemonic")!=null)
	  {
	  	if(ProjectManager.get("privacyPolicyOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnImageOK.setMnemonic(ProjectManager.get("privacyPolicyOKBtnMnemonic").charAt(0));
		}
	  }
	  }
	  else
	  ...
	  if(ProjectManager.get("privacyPolicyOKBtnMnemonic")!=null)
	  {
	  	if(ProjectManager.get("privacyPolicyOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnOK.setMnemonic(ProjectManager.get("privacyPolicyOKBtnMnemonic").charAt(0));
		}
	  }
	  }
if(isImageButton==true)
...
if(ProjectManager.get("privacyPolicyDialogSize")!=null)
{
	if(ProjectManager.get("privacyPolicyDialogSize").equalsIgnoreCase("")==false)
	{	
		Object[] tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyDialogSize"));
