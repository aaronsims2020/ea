...
import com.trinity.ea.design.optin.provider.panels.GetRespOptinProvider;
 ...
 */
public class GetRespProviderMainPanel extends EAPanel{
    
    private GetRespOptinProvider getRespOptinProvider = new GetRespOptinProvider();
    /** Creates new form GetRespProviderMainPanel */
    public GetRespProviderMainPanel() {
	  super();
        initComponents();
        getRespOptinProvider.setMasterStatusController(this);
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NewProjectImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/getresp.jpg")));
        ...
        NewProjectDescription.setText("Specify your GetResponse Autoresponder list name, and click the \"Finish\" button.");
        ...
        CenterNewProjectPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(), "GetResponse Autoresponder Configuration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        ...
        RightContentPanel.add(getRespOptinProvider, java.awt.BorderLayout.CENTER);
	...
	{ 
       setStatus("Please specify an GetResponse Autoresponder list name first.");
	}
	else
	{
       setStatus("Click to complete your GetResponse Autoresponder configuration.");
	}
    ...
    private void NewProjectImagePanelMouseEntered(java.awt.event.MouseEvent evt) {
        setStatus("GetResponse is a trademark of Simon Grabowski's Profit Studio.");
    }    
    ...
    private void NextButtonActionPerformed(java.awt.event.ActionEvent evt) {
	  try      
  	  {
		getRespOptinProvider.getDataUpdate();
