...
import com.trinity.ea.design.common.project.MJarVerificationSecurityPanel;
import com.trinity.ea.design.common.project.MX500EncryptionConfigurationPanel;
 ...
 */
public class ProductMessagingPanel extends EAPanel
{

 /** Creates new form ProductMessagingPanel */
    public ProductMessagingPanel() {
        initComponents();
        setProjectData();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        rbPanel = new MJarVerificationSecurityPanel();
        ...
        ContentPanel = new MX500EncryptionConfigurationPanel();
        ...
        lWebPage.setText("Message File Download URL:");
        lWebPage.setMaximumSize(new java.awt.Dimension(200, 15));
        lWebPage.setMinimumSize(new java.awt.Dimension(200, 15));
        lWebPage.setPreferredSize(new java.awt.Dimension(200, 15));
        ...
        MessageFileExplanationPanel.setMaximumSize(new java.awt.Dimension(32767, 80));
        MessageFileExplanationPanel.setMinimumSize(new java.awt.Dimension(315, 80));
        MessageFileExplanationPanel.setPreferredSize(new java.awt.Dimension(385, 80));
        ...
        taMessageFileExplanation.setText("The default message file name is message.eam. All message files use the file extension \".eam\", .eam is an acronym for EvaluateAnywhere Message. An Example URL: http://www.yourdomain.com/my_product/v1/messages/message.eam.");
        taMessageFileExplanation.setWrapStyleWord(true);
        taMessageFileExplanation.setMaximumSize(new java.awt.Dimension(360, 80));
        taMessageFileExplanation.setMinimumSize(new java.awt.Dimension(360, 80));
        taMessageFileExplanation.setPreferredSize(new java.awt.Dimension(360, 80));
        ...
        tpMessage.addTab("Message Client Configuration", ConfigPanel);
    ...
    private void lWebPageMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lWebPageMouseEntered
        ((NewProject)getParentComponent()).setStatus("Specify the Message File Download URL.");
    ...
    private MX500EncryptionConfigurationPanel ContentPanel;
    ...
    private MJarVerificationSecurityPanel rbPanel;
    ...
    public void getDataUpdate()
    {
        try
        {
            ProjectManager.putTempNoFileWrite("msgBaseURL", tfWebPage.getText());
    ...
    public void setProjectData()
    {
		...
		{
			if(ProjectManager.get("msgBaseURL").startsWith("http://")==true)
			{
				tfWebPage.setText(ProjectManager.get("msgBaseURL"));
			}
		}
