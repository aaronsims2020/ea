...
public class MX500EncryptionConfigurationPanel extends EAPanel {
   ...
   public synchronized void getDataUpdate()
   {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        taX500PrincipalDescription.setBackground(getBackground());
        ...
        taX500PrincipalDescription.setText("Click the \"Find Subject X500 Principal...\" button to select a Jar file that was already signed with the digital signature that will be used for messaging, and select the X500 Principal (Subject Distinguished Name), to be used for identity validation (required in Secure Mode).");
