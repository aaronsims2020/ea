 ...
 */
public class ProductOptinPanel extends EAPanel {
    
    /** Creates new ProductOptinPanel */
    public ProductOptinPanel() 
    {
        initComponents();
        try
        {
    ...
    public synchronized void setProjectData()
    {
        try
        {
            ...
            {
                if(ProjectManager.get("product_privacy_policy_email").equalsIgnoreCase("")==false)
                {
                    PrivacyPolicyTextField.setText(ProjectManager.get("product_privacy_policy_email"));
                }
            }
        }
        catch(Exception e)
    ...
    public void getDataUpdate()
    {
        try
        {
	    ProjectManager.putTempNoFileWrite("product_privacy_policy_email", PrivacyPolicyTextField.getText());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        PrivacyPolicyEMailLabel.setText("Privacy Policy E-mail:");
        PrivacyPolicyEMailLabel.setMaximumSize(new java.awt.Dimension(120, 16));
        PrivacyPolicyEMailLabel.setMinimumSize(new java.awt.Dimension(120, 16));
        PrivacyPolicyEMailLabel.setPreferredSize(new java.awt.Dimension(120, 16));
        ...
        PrivacyPolicyTextField.setText("privacypolicy@privacypolicyemailaddress.com");
        ...
        PrivacyPolicyTextField.setMinimumSize(new java.awt.Dimension(165, 22));
        PrivacyPolicyTextField.setPreferredSize(new java.awt.Dimension(235, 22));
        ...
        taGROffer.setBackground(javax.swing.UIManager.getDefaults().getColor("Panel.background"));
        taGROffer.setFont(new java.awt.Font("Arial", 0, 11));
        taGROffer.setLineWrap(true);
        taGROffer.setText("Get your FREE GetResponse account NOW! Select GetResponse, and click the \"Create New Account\" button in the next step.");
        taGROffer.setEditable(false);
        taGROffer.setWrapStyleWord(true);
        taGROffer.setMaximumSize(new java.awt.Dimension(360, 30));
        taGROffer.setMinimumSize(new java.awt.Dimension(360, 30));
        taGROffer.setPreferredSize(new java.awt.Dimension(360, 30));
        GRAdPanel.add(taGROffer);
    ...
    private void PrivacyPolicyEMailLabelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PrivacyPolicyEMailLabelMouseEntered
        ((NewProject)getParentComponent()).setStatus("The E-mail address product users can contact you for privacy policy inquiries."); 
    ...
    private void ProjectListScrollPaneMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProjectListScrollPaneMouseEntered
        ((NewProject)getParentComponent()).setStatus("Select your Opt-In Autoresponder provider, and click \"Next\" to continue."); 
