/*
 * DataContentPanelSecondTier.java
 *
 ...
 */
public class DataContentPanelSecondTier extends EAPanel {
    
    /** Creates new form UIStringsTitle */
    public DataContentPanelSecondTier(String title) {
        initComponents();
        setTitle(title);       
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        NorthActionPanel.setBackground(new java.awt.Color(100, 120, 170));
        ...
        SouthActionPanel.setBackground(new java.awt.Color(100, 120, 170));
        ...
        WestActionPanel.setBackground(new java.awt.Color(100, 120, 170));
        WestActionPanel.setPreferredSize(new java.awt.Dimension(5, 5));
        add(WestActionPanel, java.awt.BorderLayout.WEST);

        EastActionPanel.setBackground(new java.awt.Color(100, 120, 170));
        ...
        CenterActionPanel.setBackground(new java.awt.Color(100, 120, 170));
        CenterActionPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(140, 171, 240), new java.awt.Color(27, 44, 76)), "Testing", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        CenterContentPanel.setLayout(new java.awt.BorderLayout());

        CenterContentPanel.setBackground(new java.awt.Color(100, 120, 170));
        CenterActionPanel.add(CenterContentPanel, java.awt.BorderLayout.CENTER);

        WestActionPanel1.setBackground(new java.awt.Color(100, 120, 170));
        WestActionPanel1.setPreferredSize(new java.awt.Dimension(10, 10));
        CenterActionPanel.add(WestActionPanel1, java.awt.BorderLayout.WEST);

        EastActionPanel1.setBackground(new java.awt.Color(100, 120, 170));
        EastActionPanel1.setMinimumSize(new java.awt.Dimension(10, 10));
        EastActionPanel1.setPreferredSize(new java.awt.Dimension(10, 10));
        CenterActionPanel.add(EastActionPanel1, java.awt.BorderLayout.EAST);

        NorthActionPanel1.setBackground(new java.awt.Color(100, 120, 170));
        ...
        SouthActionPanel1.setBackground(new java.awt.Color(100, 120, 170));
        SouthActionPanel1.setMinimumSize(new java.awt.Dimension(10, 10));
        SouthActionPanel1.setPreferredSize(new java.awt.Dimension(10, 10));
  ...
  public synchronized void setTitle(String title)
  {
    if(title!=null)
    {
      CenterActionPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(140, 171, 240), new java.awt.Color(27, 44, 76)), title, javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
    }
  }
