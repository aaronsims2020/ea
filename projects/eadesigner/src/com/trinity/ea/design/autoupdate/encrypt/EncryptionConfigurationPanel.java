...
public class EncryptionConfigurationPanel extends EAPanel {
   ...
   public synchronized void getDataUpdate()
   {
		...
		ProjectManager.putTempNoFileWrite("autoUpdatePwdSeed", tfSoftwareTitle1.getText());
		SpinnerNumberModel sm = (SpinnerNumberModel)spinMaxRegistrationAttempts.getModel();
		ProjectManager.putTempNoFileWrite("autoUpdatePwdCount", String.valueOf(sm.getNumber().intValue()));
    ...
    public synchronized void setProjectData()
    {
		...
		// Registration Code Serial Number TextField  
		    ...
		    tfSoftwareTitle1.setText(ProjectManager.get("autoUpdatePwdSeed"));
		    ...
		    spinMaxRegistrationAttempts.setOpaque(true);
   		    spinMaxRegistrationAttempts.setModel(new SpinnerNumberModel(Integer.valueOf(ProjectManager.get("autoUpdatePwdCount")),new Integer(1),new Integer(999),new Integer(1)));
		}
        }
        catch(Exception e)
        {
