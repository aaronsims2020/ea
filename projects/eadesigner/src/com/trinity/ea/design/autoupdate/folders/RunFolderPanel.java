 ...
 */
public class RunFolderPanel extends EAPanel {
    ...
    public void setOperatingEnvironment(int operatingEnvironment)
    {
	  ...
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Java Run Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==0)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Windows Run Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==1)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "UNIX Run Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==3)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Macintosh OS X Run Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  setProjectData();
    }    
    ...
    /** Creates new form RunFolderPanel */
    public RunFolderPanel() {
        initComponents();
        setProjectData();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        taRootFolderDescription.setText("The \"Run Folder\" is the location software is run with automatic update support enabled. The run directory allows installed files to be overwritten with an automatic update while the application is running.");
        ...
        lComboHeaderLabel.setText("Define Run Folder:");
    ...
    private void setEAJarFolderSelected()
    {
		...
		{
			((AutoUpdateFoldersPanel)getParentComponent()).setRunFolderNormal();
		}
            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRunDirSystemPropertyEnabled", "false", getOperatingEnvironment());
            lPropertyHeaderLabel.setText("Sub-Folder (if applicable):");
            lDirectoryHeaderLabel2.setVisible(false);
            taRootFolder2.setEnabled(false);
		lFiller2.setText(" /");
		lFiller6.setText("");
            if(ProjectManager.get("autoUpdateRunDir")!=null)
            {
                 taRootFolder1.setText(trimUnusedFirstForwardSlash(ProjectManager.getSystemPropertyExtendedValue(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRunDir",getOperatingEnvironment()))));
            }
        }
        catch(Exception e)
        {
    ...
    private void setSystemPropertySelected()
    {
		...
		if(((AutoUpdateFoldersPanel)getParentComponent())!=null)
		{
			((AutoUpdateFoldersPanel)getParentComponent()).setRunFolderIsSystemProperty();
		}
            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRunDirSystemPropertyEnabled", "true", getOperatingEnvironment());
		...
		lFiller6.setText(" /");
            ...
            if(ProjectManager.get("autoUpdateRunDir")!=null)
            {
                unparsedString = ProjectManager.getSystemPropertyPlatformValue("autoUpdateRunDir",getOperatingEnvironment());
            ...
            if(ProjectManager.get("/$RUN_DIR/$")!=null)
            {
                taRootFolder1.setText(ProjectManager.getSystemPropertyPlatformValue("/$RUN_DIR/$",getOperatingEnvironment()));
            }
        }
        catch(Exception e)
        {
	...
	try
	{
		strRootFolder1 = taRootFolder1.getText();
            if(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRunDirSystemPropertyEnabled",getOperatingEnvironment()).equalsIgnoreCase("true")==true)
            {
                if(comboRootFolder1.getSelectedIndex()==1)
                {
			...
			if(strRootFolder2.equalsIgnoreCase("")==false && strRootFolder2.startsWith("/")==false)
			{
	            ...
	            ProjectManager.putSystemPropertyPlatformValue("/$RUN_DIR/$", strRootFolder1, getOperatingEnvironment());
      	      ProjectManager.putSystemPropertyPlatformValue("autoUpdateRunDir", "/$RUN_DIR/$" + strRootFolder2, getOperatingEnvironment());
                }
                else if(comboRootFolder1.getSelectedIndex()==2)
                {
			if(strRootFolder1.equalsIgnoreCase("")==false && strRootFolder1.startsWith("/")==false)
			{
            	...
            	ProjectManager.putSystemPropertyPlatformValue("autoUpdateRunDir", "/$USER_HOME_DIR/$" + strRootFolder1, getOperatingEnvironment());
                }
            }
            else
            {
			if(strRootFolder1.equalsIgnoreCase("")==false && strRootFolder1.startsWith("/")==false)
			{
	            ...
	            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRunDir", strRootFolder1, getOperatingEnvironment());
            }
    ...
    public synchronized void setProjectData()
    {
		...
		// Auto Update Support Functionality Checkbox Enabled/Disabled   
            if(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRunDirSystemPropertyEnabled",getOperatingEnvironment()).equalsIgnoreCase("true")==true)
            {
                ...
                if(ProjectManager.get("autoUpdateRunDir")!=null)
                {
                    systemPropertyType = ProjectManager.getSystemPropertyDefine(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRunDir",getOperatingEnvironment()));
