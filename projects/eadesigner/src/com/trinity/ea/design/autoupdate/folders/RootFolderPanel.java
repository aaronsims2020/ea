 ...
 */
public class RootFolderPanel extends EAPanel {
    ...
    public void setOperatingEnvironment(int operatingEnvironment)
    {
	  ...
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Java Application Root Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==0)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Windows Application Root Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==1)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "UNIX Application Root Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  else if(operatingEnvironment==3)
	  {
	        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Macintosh OS X Application Root Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
	  }
	  setProjectData();
    }    
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        AutoUpdateApplicationRootPanel.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(122, 133, 168)), "Application Root Folder", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        ...
        taRootFolderDescription.setText("Specify the \"Application Root Folder\" by the location of the EvaluateAnywhere Jar file, select a pre-defined folder, or select \"System Property\" to specify a developer defined System Property directory.");
        ...
        lComboHeaderLabel.setText("Define Application Root Folder:");
        ...
        comboRootFolder1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "EvaluateAnywhere Jar Folder", "System Property", "User's Home Folder" }));
    ...
    private void setEAJarFolderSelected()
    {
		...
		{
			((AutoUpdateFoldersPanel)getParentComponent()).setRootFolderNormal();
		}
            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRootDirSystemPropertyEnabled", "false", getOperatingEnvironment());
            lPropertyHeaderLabel.setText("Sub-Folder (if applicable):");
            lDirectoryHeaderLabel2.setVisible(false);
            taRootFolder2.setEnabled(false);
		lFiller2.setText(" /");
		lFiller6.setText("");
            if(ProjectManager.get("autoUpdateRootDir")!=null)
            {
                 taRootFolder1.setText(trimUnusedFirstForwardSlash(ProjectManager.getSystemPropertyExtendedValue(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRootDir",getOperatingEnvironment()))));
            }
        }
        catch(Exception e)
        {
    ...
    private void setSystemPropertySelected()
    {
		...
		if(((AutoUpdateFoldersPanel)getParentComponent())!=null)
		{
			((AutoUpdateFoldersPanel)getParentComponent()).setRootFolderIsSystemProperty();
		}
            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRootDirSystemPropertyEnabled", "true", getOperatingEnvironment());
		...
		lFiller6.setText(" /");
            ...
            if(ProjectManager.get("autoUpdateRootDir")!=null)
            {
                unparsedString = ProjectManager.getSystemPropertyPlatformValue("autoUpdateRootDir",getOperatingEnvironment());
            ...
            if(ProjectManager.get("/$ROOT_DIR/$")!=null)
            {
                taRootFolder1.setText(ProjectManager.getSystemPropertyPlatformValue("/$ROOT_DIR/$",getOperatingEnvironment()));
            }
        }
        catch(Exception e)
        {
    ...
    public synchronized void setProjectData()
    {
		...
		// Auto Update Support Functionality Checkbox Enabled/Disabled   
            if(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRootDirSystemPropertyEnabled",getOperatingEnvironment()).equalsIgnoreCase("true")==true)
            {
                String unparsedString = null;
                String systemPropertyType = null;
                if(ProjectManager.get("autoUpdateRootDir")!=null)
                {
                    systemPropertyType = ProjectManager.getSystemPropertyDefine(ProjectManager.getSystemPropertyPlatformValue("autoUpdateRootDir",getOperatingEnvironment()));
	...
	try
	{
		strRootFolder1 = taRootFolder1.getText();
			...
			if(strRootFolder2.equalsIgnoreCase("")==false && strRootFolder2.startsWith("/")==false)
			{
            	...
            	ProjectManager.putSystemPropertyPlatformValue("/$ROOT_DIR/$", strRootFolder1, getOperatingEnvironment());
            	ProjectManager.putSystemPropertyPlatformValue("autoUpdateRootDir", "/$ROOT_DIR/$" + strRootFolder2, getOperatingEnvironment());
               }
                else if(comboRootFolder1.getSelectedIndex()==2)
                {
			if(strRootFolder1.equalsIgnoreCase("")==false && strRootFolder1.startsWith("/")==false)
			{
            	...
            	ProjectManager.putSystemPropertyPlatformValue("autoUpdateRootDir", "/$USER_HOME_DIR/$" + strRootFolder1, getOperatingEnvironment());
                }
            }
            else
            {
			if(strRootFolder1.equalsIgnoreCase("")==false && strRootFolder1.startsWith("/")==false)
			{
	            ...
	            ProjectManager.putSystemPropertyPlatformValue("autoUpdateRootDir", strRootFolder1, getOperatingEnvironment());
            }
