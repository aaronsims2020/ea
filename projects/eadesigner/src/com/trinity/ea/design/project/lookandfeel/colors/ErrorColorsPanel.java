...
public class ErrorColorsPanel extends EAPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultProgressPanelTextColor.setSelected(true);
        useDefaultProgressPanelTextColor.setText("Use default error window background color");
        ...
        useDefaultProgressPanelLeftBorderColor.setSelected(true);
        useDefaultProgressPanelLeftBorderColor.setText("Use default error message background color");
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default error window text color");
    ...
    private void useDefaultProgressPanelLeftBorderColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelLeftBorderColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("errtextbgclr", "");
                ProjectManager.put("errImgBackgroundColor", "");
                //ProjectManager.remove("errtextbgclr");                
                progressPanelLeftBorderColorChooserButton.setVisible(false);                      
            }
            else 
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("errtextbgclr")!=null)
        {
            if(ProjectManager.get("errtextbgclr").equalsIgnoreCase("")==false)
            {
                ...
                ProjectManager.put("errtextbgclr", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
                ProjectManager.put("errImgBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultProgressPanelTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("errbgclr", "");
                //ProjectManager.remove("errbgclr");       
                progressPanelTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("errbgclr")!=null)
        {
            if(ProjectManager.get("errbgclr").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("errbgclr", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultButtonBarTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultButtonBarTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("errfontclr", "");
                //ProjectManager.remove("errfontclr");     
                buttonBarTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("errfontclr")!=null)
        {
            if(ProjectManager.get("errfontclr").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("errfontclr", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
