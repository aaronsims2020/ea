...
public class RegistrationColorsPanel extends EAPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultProgressPanelTextColor.setSelected(true);
        useDefaultProgressPanelTextColor.setText("Use default registration window background color");
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default registration window text color");
    ...
    private void useDefaultProgressPanelTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("registrationBackgroundColor", "");
                //ProjectManager.remove("registrationBackgroundColor");       
                progressPanelTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("registrationBackgroundColor")!=null)
        {
            if(ProjectManager.get("registrationBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                ProjectManager.put("registrationBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultButtonBarTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultButtonBarTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("registrationTextColor", "");
                //ProjectManager.remove("registrationTextColor");     
                buttonBarTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("registrationTextColor")!=null)
        {
            if(ProjectManager.get("registrationTextColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("registrationTextColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
