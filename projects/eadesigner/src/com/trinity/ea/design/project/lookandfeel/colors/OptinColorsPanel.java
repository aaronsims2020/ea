...
public class OptinColorsPanel extends EAPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultProgressPanelTextColor.setSelected(true);
        useDefaultProgressPanelTextColor.setText("Use default opt-in window background color");
        ...
        useDefaultProgressPanelLeftBorderColor.setSelected(true);
        useDefaultProgressPanelLeftBorderColor.setText("Use default privacy policy text link color");
        ...
        ProjectLookAndFeelImages4.getAccessibleContext().setAccessibleName("Privacy Policy Text Link Color");
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default opt-in window text color");
    ...
    private void useDefaultProgressPanelLeftBorderColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelLeftBorderColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("optinPrivacyPolicyTextColor", "");
                //ProjectManager.remove("optinPrivacyPolicyTextColor");                
                progressPanelLeftBorderColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("optinPrivacyPolicyTextColor")!=null)
        {
            if(ProjectManager.get("optinPrivacyPolicyTextColor").equalsIgnoreCase("")==false)
            {
                ...
                ProjectManager.put("optinPrivacyPolicyTextColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultProgressPanelTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("optinBackgroundColor", "");
                //ProjectManager.remove("optinBackgroundColor");       
                progressPanelTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("optinBackgroundColor")!=null)
        {
            if(ProjectManager.get("optinBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("optinBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultButtonBarTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultButtonBarTextColorActionPerformed
        try
        {
            if(useDefaultButtonBarTextColor.isSelected()==true)
            {
                ...
                //ProjectManager.remove("optinButtonTextColor");     
                buttonBarTextColorChooserButton.setVisible(false);                      
            }
            else
            {
