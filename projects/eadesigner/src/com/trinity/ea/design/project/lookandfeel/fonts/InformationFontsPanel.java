 ...
 */
public class InformationFontsPanel extends EAPanel {

    /** Creates new form ImagesPanel */
    public InformationFontsPanel() 
    {
        initComponents();
    ...
    public synchronized void setProjectData()
    {
        try
        {
            ...
            {
                if(ProjectManager.get("informationTextFont").equalsIgnoreCase("")==false)
                {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default information dialog text font");
 ...
 if(ProjectManager.get("informationTextFont")!=null)
        {
            if(ProjectManager.get("informationTextFont").equalsIgnoreCase("")==false)
            {
                ...
                if(retFont!=null)
                {
                    ProjectManager.putTempNoFileWrite("informationTextFont",retFont.getName() + "," + String.valueOf(retFont.getStyle()) + "," + String.valueOf(retFont.getSize()));
                }
                tmpArray = getStringArraysFromString(ProjectManager.get("informationTextFont"));
                demoButtonBarFont.setFont(new Font((String)tmpArray[0],new Integer((String)tmpArray[1]).intValue(), new Integer((String)tmpArray[2]).intValue()));
                demoButtonBarFont.setText((String)tmpArray[0] + ", " + (String)tmpArray[1] + ", " + (String)tmpArray[2]);
            }
            else
