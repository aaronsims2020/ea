...
import com.trinity.ea.design.optin.actions.PrivacyPolicyAction;
...
public class PrivacyColorsPanel extends EAPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultProgressPanelTextColor.setSelected(true);
        useDefaultProgressPanelTextColor.setText("Use default privacy window background color");
        ...
        ProjectLookAndFeelImages4.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EtchedBorder(new java.awt.Color(198, 226, 253), new java.awt.Color(96, 110, 145)), "Privacy Policy Message Background Color", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12)));
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default privacy window text color");
    ...
    private void useDefaultProgressPanelTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("privacyPolicyBackgroundColor", "");
                //ProjectManager.remove("privacyPolicyBackgroundColor");       
                progressPanelTextColorChooserButton.setVisible(false);                      
            }
            else
            {
    ...
    private void useDefaultProgressPanelLeftBorderColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelLeftBorderColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("privacyPolicyTextBackgroundColor", "");
                //ProjectManager.remove("privacyPolicyTextBackgroundColor");                
                progressPanelLeftBorderColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("privacyPolicyTextBackgroundColor")!=null)
        {
            if(ProjectManager.get("privacyPolicyTextBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                ProjectManager.put("privacyPolicyTextBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("privacyPolicyBackgroundColor")!=null)
        {
            if(ProjectManager.get("privacyPolicyBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("privacyPolicyBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultButtonBarTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultButtonBarTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("privacyPolicyTextColor", "");
                //ProjectManager.remove("privacyPolicyTextColor");     
                buttonBarTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("privacyPolicyTextColor")!=null)
        {
            if(ProjectManager.get("privacyPolicyTextColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("privacyPolicyTextColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
