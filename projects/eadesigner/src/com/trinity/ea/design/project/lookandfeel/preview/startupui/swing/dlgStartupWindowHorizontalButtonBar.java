...
public class dlgStartupWindowHorizontalButtonBar extends javax.swing.JDialog {
	...
	daysLeft.setText(Long.toString(days) + " Days");
        try
        {
            setTitle(ProjectManager.get("startWindowTitle"));
        }
        catch(Exception e){}
    ...
    private void lEvaluateAnywhereInfoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lEvaluateAnywhereInfoMouseClicked
            ...
            if(ProjectManager.get("startWindowBottomLabelAction")!=null)
            {
                try
                {
                    //dispose();
                    Class.forName(ProjectManager.get("startWindowBottomLabelAction")).newInstance();
                }
    ...
    private void btnEnterRegistrationCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterRegistrationCodeActionPerformed
                ...
                if(ProjectManager.get("enterRegistrationCodeAction")!=null)
                {
                    ...
                    {
                        //dispose();
                        Class.forName(ProjectManager.get("enterRegistrationCodeAction")).newInstance();
                    }
                    catch(InstantiationException e)
                    {
                        System.out.println(e);
    ...
    private void btnBuyNowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuyNowActionPerformed
                if(ProjectManager.get("buyNowAction")!=null)
                {
                    ...
                    {
                        //dispose();
                        Class.forName(ProjectManager.get("buyNowAction")).newInstance();
                    }
                    catch(InstantiationException e)
                    {
                        System.out.println(e);
    ...
    private void btnUseEvaluationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUseEvaluationActionPerformed
                if(ProjectManager.get("useEvaluationAction")!=null)
                {
                    try
                    {
                        setVisible(false);
                        dispose();
                        Class.forName(ProjectManager.get("useEvaluationAction")).newInstance();
                    }
                    catch(InstantiationException e)
                    {
                        System.out.println(e);
