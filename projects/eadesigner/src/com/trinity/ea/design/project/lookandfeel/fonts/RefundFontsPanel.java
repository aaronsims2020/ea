 ...
 */
public class RefundFontsPanel extends EAPanel {

    /** Creates new form ImagesPanel */
    public RefundFontsPanel() 
    {
        initComponents();
    ...
    public synchronized void setProjectData()
    {
        try
        {
            ...
            {
                if(ProjectManager.get("refundPolicyTextFont").equalsIgnoreCase("")==false)
                {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setText("Use default text font");
 ...
 if(ProjectManager.get("refundPolicyTextFont")!=null)
        {
            if(ProjectManager.get("refundPolicyTextFont").equalsIgnoreCase("")==false)
            {
                ...
                if(retFont!=null)
                {
                    ProjectManager.putTempNoFileWrite("refundPolicyTextFont",retFont.getName() + "," + String.valueOf(retFont.getStyle()) + "," + String.valueOf(retFont.getSize()));
                }
                tmpArray = getStringArraysFromString(ProjectManager.get("refundPolicyTextFont"));
                demoButtonBarFont.setFont(new Font((String)tmpArray[0],new Integer((String)tmpArray[1]).intValue(), new Integer((String)tmpArray[2]).intValue()));
                demoButtonBarFont.setText((String)tmpArray[0] + ", " + (String)tmpArray[1] + ", " + (String)tmpArray[2]);
            }
            else
