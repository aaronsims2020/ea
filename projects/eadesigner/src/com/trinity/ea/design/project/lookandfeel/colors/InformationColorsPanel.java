...
public class InformationColorsPanel extends EAPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        useDefaultProgressPanelTextColor.setSelected(true);
        useDefaultProgressPanelTextColor.setLabel("Use default information window background color");
        useDefaultProgressPanelTextColor.setMaximumSize(new java.awt.Dimension(340, 23));
        useDefaultProgressPanelTextColor.setMinimumSize(new java.awt.Dimension(340, 23));
        useDefaultProgressPanelTextColor.setPreferredSize(new java.awt.Dimension(340, 23));
        ...
        useDefaultProgressPanelLeftBorderColor.setSelected(true);
        useDefaultProgressPanelLeftBorderColor.setLabel("Use default information message background color");
        useDefaultProgressPanelLeftBorderColor.setMaximumSize(new java.awt.Dimension(340, 23));
        useDefaultProgressPanelLeftBorderColor.setMinimumSize(new java.awt.Dimension(340, 23));
        useDefaultProgressPanelLeftBorderColor.setPreferredSize(new java.awt.Dimension(340, 23));
        ...
        useDefaultButtonBarTextColor.setSelected(true);
        useDefaultButtonBarTextColor.setLabel("Use default information window text color");
        useDefaultButtonBarTextColor.setMaximumSize(new java.awt.Dimension(340, 23));
        useDefaultButtonBarTextColor.setMinimumSize(new java.awt.Dimension(340, 23));
        useDefaultButtonBarTextColor.setPreferredSize(new java.awt.Dimension(340, 23));
    ...
    private void useDefaultProgressPanelLeftBorderColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelLeftBorderColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("informationTextBackgroundColor", "");
                //ProjectManager.remove("informationTextBackgroundColor");                
                progressPanelLeftBorderColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("informationTextBackgroundColor")!=null)
        {
            if(ProjectManager.get("informationTextBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                ProjectManager.put("informationTextBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultProgressPanelTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultProgressPanelTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("informationBackgroundColor", "");
                //ProjectManager.remove("informationBackgroundColor");       
                progressPanelTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("informationBackgroundColor")!=null)
        {
            if(ProjectManager.get("informationBackgroundColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("informationBackgroundColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
    ...
    private void useDefaultButtonBarTextColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_useDefaultButtonBarTextColorActionPerformed
        try
        {
            ...
            {
                ProjectManager.put("informationTextColor", "");
                //ProjectManager.remove("informationTextColor");     
                buttonBarTextColorChooserButton.setVisible(false);                      
            }
            else
            {
 	...
 	// Bring up a color chooser 
        if(ProjectManager.get("informationTextColor")!=null)
        {
            if(ProjectManager.get("informationTextColor").equalsIgnoreCase("")==false)
            {
                ...
                Color c = JLocalColorChooser.showDialog(this,"Color Chooser",new java.awt.Color(new Integer((String)tmpArray[0]).intValue(), new Integer((String)tmpArray[1]).intValue(),new Integer((String)tmpArray[2]).intValue())); 
                ProjectManager.put("informationTextColor", String.valueOf(c.getRed()) + "," + String.valueOf(c.getGreen()) + "," + String.valueOf(c.getBlue()));
