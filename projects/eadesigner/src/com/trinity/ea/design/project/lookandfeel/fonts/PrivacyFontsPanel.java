 ...
 */
public class PrivacyFontsPanel extends EAPanel {

    /** Creates new form ImagesPanel */
    public PrivacyFontsPanel() 
    {
        initComponents();
    ...
    public synchronized void setProjectData()
    {
        try
        {
            ...
            {
                if(ProjectManager.get("privacyPolicyTextFont").equalsIgnoreCase("")==false)
                {
 ...
 if(ProjectManager.get("privacyPolicyTextFont")!=null)
        {
            if(ProjectManager.get("privacyPolicyTextFont").equalsIgnoreCase("")==false)
            {
                ...
                if(retFont!=null)
                {
                    ProjectManager.putTempNoFileWrite("privacyPolicyTextFont",retFont.getName() + "," + String.valueOf(retFont.getStyle()) + "," + String.valueOf(retFont.getSize()));
                }
                tmpArray = getStringArraysFromString(ProjectManager.get("privacyPolicyTextFont"));
                demoButtonBarFont.setFont(new Font((String)tmpArray[0],new Integer((String)tmpArray[1]).intValue(), new Integer((String)tmpArray[2]).intValue()));
                demoButtonBarFont.setText((String)tmpArray[0] + ", " + (String)tmpArray[1] + ", " + (String)tmpArray[2]);
            }
            else
