...
try {
        ...
        while ((str = in.readLine()) != null) 
	  {
        ...
        in.close();
	  strHTMLSource = sb1.toString();
    } catch (IOException e) 
    {
	e.printStackTrace();
    }
            kit.read(new StringReader(strHTMLSource), doc, 0);
		    ...
		    if(elem.getName().equalsIgnoreCase("comment")==true)
			{
			  ...
			  sb.append("<!--");
                    ...
                    if(attributeNames != null)
                    {
                        ...
                        {
                            Object el = attributeNames.nextElement();
             		    sb.append(attributeNames.nextElement().toString());
                        }
                    }
			  sb.append("-->");
			  commentString = commentString + sb.toString();
			}
            }
        } 
        catch (Exception e) 
     ...
     */
     ...
     /* Returns a String with all the document comments */
