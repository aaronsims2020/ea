...
package com.trinity.ea.forms.info;
...
if(isImageButton==true)
{
	  ...
	  else
	  {
        ...
        if(EncryptedRuleReader.getLocaleString("informationTextTitle")!=null)
        {
        	setTitle(EncryptedRuleReader.getLocaleString("informationTextTitle"));
	  }
	  ...
	  Policy.setCaretPosition(0);
		if(EncryptedRuleReader.get("informationTextBackgroundColor")!=null)
		{
			if(EncryptedRuleReader.get("informationTextBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationTextBackgroundColor"));
		...
		if(EncryptedRuleReader.get("informationTextColor")!=null)
		{
			if(EncryptedRuleReader.get("informationTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationTextColor"));
		...
		if(EncryptedRuleReader.get("informationButtonTextColor")!=null)
		{
			if(EncryptedRuleReader.get("informationButtonTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationButtonTextColor"));
		...
		if(EncryptedRuleReader.get("informationBackgroundColor")!=null)
		{
			if(EncryptedRuleReader.get("informationBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationBackgroundColor"));
...
private int getHorizontalInsetAdjustment(int actualLeftInset, int actualRightInset)
{
    ...
    private void initComponents(boolean isImgButton) {//GEN-BEGIN:initComponents
	  ...
	  Policy.setLineWrap(true);
		if(EncryptedRuleReader.getLocaleString("informationText")!=null)
		{

	  		Policy.setText(EncryptedRuleReader.getLocaleString("informationText").replaceAll("\\\\r\\\\n", System.getProperty("line.separator")));         
		} 
		...
		setResizable(false);
		if(EncryptedRuleReader.get("informationTextFont")!=null)
		{
			Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationTextFont"));
		...
		if(EncryptedRuleReader.getLocaleString("informationOKBtnText")!=null)
		{
        if(isImageButton==true)
	  {
        	btnImageOK.setText(EncryptedRuleReader.getLocaleString("informationOKBtnText"));
	  }
	  else
	  {
        	btnOK.setText(EncryptedRuleReader.getLocaleString("informationOKBtnText"));
	  }
	  }
	  else
	  {
	  ...
	  if(isImageButton==true)
	  {
	  if(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic")!=null)
	  {
	  	if(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnImageOK.setMnemonic(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic").charAt(0));
		}
	  }
	  }
	  else
	  ...
	  if(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic")!=null)
	  {
	  	if(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnOK.setMnemonic(EncryptedRuleReader.getLocaleString("informationOKBtnMnemonic").charAt(0));
		}
	  }
	  }
if(isImageButton==true)
...
if(EncryptedRuleReader.get("informationDialogSize")!=null)
{
	Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("informationDialogSize"));
