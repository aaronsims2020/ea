...
public class PrivacyPolicy extends javax.swing.JDialog {
 ...
 if(isImageButton==true)
 {
	  ...
	  else
	  {
        ...
        if(EncryptedRuleReader.getLocaleString("privacyPolicyTitle")!=null)
        {
        	setTitle(EncryptedRuleReader.getLocaleString("privacyPolicyTitle"));
	  }
	  ...
	  Policy.setCaretPosition(0);
		if(EncryptedRuleReader.get("privacyPolicyTextBackgroundColor")!=null)
		{
			if(EncryptedRuleReader.get("privacyPolicyTextBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyTextBackgroundColor"));
		...
		if(EncryptedRuleReader.get("privacyPolicyTextColor")!=null)
		{
			if(EncryptedRuleReader.get("privacyPolicyTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyTextColor"));
		...
		if(EncryptedRuleReader.get("privacyPolicyButtonTextColor")!=null)
		{
			if(EncryptedRuleReader.get("privacyPolicyButtonTextColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyButtonTextColor"));
		...
		if(EncryptedRuleReader.get("privacyPolicyBackgroundColor")!=null)
		{
			if(EncryptedRuleReader.get("privacyPolicyBackgroundColor").equalsIgnoreCase("")==false)
			{
				Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyBackgroundColor"));
...
private int getHorizontalInsetAdjustment(int actualLeftInset, int actualRightInset)
{
    ...
    private void initComponents(boolean isImgButton) {//GEN-BEGIN:initComponents
	  ...
	  Policy.setLineWrap(true);
		if(EncryptedRuleReader.getLocaleString("privacyPolicy")!=null)
		{

	  		Policy.setText(EncryptedRuleReader.getLocaleString("privacyPolicy").replaceAll("\\\\r\\\\n", System.getProperty("line.separator")));         
		} 
		...
		setResizable(false);
		if(EncryptedRuleReader.get("privacyPolicyTextFont")!=null)
		{
			Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyTextFont"));
		...
		if(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnText")!=null)
		{
        if(isImageButton==true)
	  {
        	btnImageOK.setText(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnText"));
	  }
	  else
	  {
        	btnOK.setText(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnText"));
	  }
	  }
	  else
	  {
	  ...
	  if(isImageButton==true)
	  {
	  if(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic")!=null)
	  {
	  	if(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnImageOK.setMnemonic(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic").charAt(0));
		}
	  }
	  }
	  else
	  ...
	  if(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic")!=null)
	  {
	  	if(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic").equalsIgnoreCase("")==false)
	  	{
	      	btnOK.setMnemonic(EncryptedRuleReader.getLocaleString("privacyPolicyOKBtnMnemonic").charAt(0));
		}
	  }
	  }
if(isImageButton==true)
...
if(EncryptedRuleReader.get("privacyPolicyDialogSize")!=null)
{
	if(EncryptedRuleReader.get("privacyPolicyDialogSize").equalsIgnoreCase("")==false)
	{	
		Object[] tmpArray = getStringArraysFromString(EncryptedRuleReader.get("privacyPolicyDialogSize"));
...
//
	  if(EncryptedRuleReader.get("customScrollBarsEnabled")!=null)
	  {
	  	...
	  	{ 
JScrollBar spvBar = PrivacyPolicyScrollPane.getVerticalScrollBar();
...
PrivacyPolicyScrollPane.setVerticalScrollBar(spvBar);
//
//
		}
	}
 ...
 //   }
   ...
   public void setBackgroundColor(Color BGColor)
   {
	try
	{
		...
		PrivacyPolicyScrollPane.setBackground(BGColor);
