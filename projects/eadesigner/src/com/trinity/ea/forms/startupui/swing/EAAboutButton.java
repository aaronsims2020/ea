...
if(EncryptedRuleReader.get("progressPanelImgPath")!=null)
{
	if(EncryptedRuleReader.get("progressPanelImgPath").equalsIgnoreCase("")==false)
	{ 
		try
		{
			theImageRef = new javax.swing.ImageIcon(EncryptedRuleReader.getImage(getClass().getResource(EncryptedRuleReader.get("progressPanelImgPath"))));
//
			if(EncryptedRuleReader.get("progressPanelImgStretchToFitEnabled")!=null)
			{ 
				if(EncryptedRuleReader.get("progressPanelImgStretchToFitEnabled").equalsIgnoreCase("true")==true)
				{
...
//
		...
		{
			e.printStackTrace();
            	ProgressBarImage.setText(EncryptedRuleReader.getLocaleString("imageMissingText"));
        		ProgressBarImage.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		}
