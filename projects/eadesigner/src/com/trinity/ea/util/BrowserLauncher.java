...
public class BrowserLauncher {
	...
	private static final int WINDOWS_9x = 6;
 	...
 	/** JVM constant for any Solaris JVM */
	private static final int SOLARIS = 777;     
	...
	public static void openURL(String url) throws IOException {
		...
		switch (jvm) {
		    ...
		    case WINDOWS_9x:
				...
				break;
			case SOLARIS:
				// Assume that we're on Solaris and that sdtwebclient is installed
				// First, attempt to open the URL in a currently running session of sdtwebclient
				Runtime.getRuntime().exec(new String[] { (String) browser, url });
				break;                        
			case OTHER:
