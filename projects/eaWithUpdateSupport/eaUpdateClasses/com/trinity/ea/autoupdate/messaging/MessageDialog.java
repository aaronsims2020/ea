...
public class MessageDialog extends javax.swing.JDialog {
	...
	catch(Exception e)
	{
	  ...
	  if(EncryptedRuleReader.get("customScrollBarsEnabled")!=null)
	  {
	 	...
	 	UIManager.put("ScrollBar.background", new javax.swing.plaf.ColorUIResource(119, 151, 172));
	  	UIManager.put("ScrollBar.track", new javax.swing.plaf.ColorUIResource(222, 226, 226));
	  	UIManager.put("ScrollBar.thumb", new javax.swing.plaf.ColorUIResource(38,54,69));
	  	UIManager.put("ScrollBar.background", new javax.swing.plaf.ColorUIResource(119, 151, 172));
	  	UIManager.put("ScrollBar.foreground", new javax.swing.plaf.ColorUIResource(255, 255, 255));

	  	UIManager.put("ScrollBar.thumbHighlightColor", new javax.swing.plaf.ColorUIResource(255,255,255));
	  	UIManager.put("ScrollBar.thumbLightShadowColor", new javax.swing.plaf.ColorUIResource(38,54,69));
	  	UIManager.put("ScrollBar.thumbDarkShadowColor", new javax.swing.plaf.ColorUIResource(255,255,255));
		UIManager.put("controlDkShadow",Color.white);
		UIManager.put("controlShadow", new java.awt.Color(38,54,69));
		UIManager.put("controlLtHighlight",new java.awt.Color(38,54,69));
	...
	if(EncryptedRuleReader.get("msgHeaderImgPath")!=null)
	{
 		if(EncryptedRuleReader.get("msgHeaderImgPath").equalsIgnoreCase("")==false)
		{
       		...
       		NorthPanel.setPreferredSize(new java.awt.Dimension(330, 30));
        		Logo.setIcon(new javax.swing.ImageIcon(getClass().getResource(EncryptedRuleReader.get("msgHeaderImgPath"))));
	  ...
	  if(EncryptedUpdateReader.get("type")!=null)
	  {
		if(EncryptedUpdateReader.get("type").equalsIgnoreCase("0")==true)
		{
			...
			if(EncryptedRuleReader.get("msgBGImgPath")!=null)
			{
				...
				{
        				final Border bkgrnd = new ImageBackgroundBorder(ImageIO.read(getClass().getResource(EncryptedRuleReader.get("msgBGImgPath"))));
...
{
        CenterPanel.add(btnOK);
        btnOK.setBounds(115, 108, btnWidthCancel, 23);
}
	  if(EncryptedUpdateReader.get("msgbtnfontclr")!=null)
	  {
		if(EncryptedUpdateReader.get("msgbtnfontclr").equalsIgnoreCase("")==false)
...
{
    jTextPane1.setText(stringMessage.replaceAll("\\\\r\\\\n", System.getProperty("line.separator")));
}
...
sbUI.setThumbColor(new java.awt.Color(222, 226, 226));
sbUI.setTrackColor(new java.awt.Color(38,54,69));
sbUI.setThumbHighlightColor(new java.awt.Color(38,54,69));
sbUI.setThumbLightShadowColor(new java.awt.Color(38,54,69));
sbUI.setThumbDarkShadowColor(new java.awt.Color(38,54,69));
sbUI.setTrackHighlightColor(new java.awt.Color(38,54,69));
spvBar.setUI(sbUI); // no try/catch needed here...
spvBar.getComponent(0).setBackground(new java.awt.Color(38,54,69));
//spvBar.getComponent(0).setForeground(Color.white);
